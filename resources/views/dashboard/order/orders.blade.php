...
<h4 style="color:#fff;"> Total of orders : {{$value->count()}} </h4>
                    <table>
                        <tr style="background:#E95F71; color:#fff;">
                            <td style=" padding:20px;" colspan="4"> 
                            <h3> <i class="fa fa-bell-o"></i> Orders</h3> 
                        </td>
                        </tr>
...
<tr style="height:60px; border-bottom:1px solid #c0c0c0; background:#ccc;">
                    ...
                    <a href="{{route('one.order',$order->id)}}">
                    <i class="fa fa-cube"></i>
                   <span style="color:#000;"> {{$order->product}} </span>
                    </a>
                    </td>
                ...
                <span style="color:#000;">   {{ \Carbon\Carbon::parse($order->updated_at)->diffForHumans() }} </span>
                     </a>
                    </td>

                    <td>
<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop{{$order->id}}">
Delelte
</button>
